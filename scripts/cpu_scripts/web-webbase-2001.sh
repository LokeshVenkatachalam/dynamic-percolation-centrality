...
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 128 --batch 10000 -o p128_q10000_cpu_dynedge_web-webbase-2001 .txt &>> $output
...
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 64  --batch 1000  -o p64_q1000_cpu_dynedge_web-webbase-2001 .txt   &>> $output
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 64  --batch 10000 -o p64_q10000_cpu_dynedge_web-webbase-2001 .txt  &>> $output
...
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 16  --batch 1000  -o p16_q1000_cpu_dynedge_web-webbase-2001 .txt   &>> $output
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 16  --batch 10000 -o p16_q10000_cpu_dynedge_web-webbase-2001 .txt  &>> $output
...
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 4   --batch 1000  -o p4_q1000_cpu_dynedge_web-webbase-2001 .txt    &>> $output
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 4   --batch 10000 -o p4_q10000_cpu_dynedge_web-webbase-2001 .txt   &>> $output
...
python3 run.py --algorithm dynedge --dataset web-webbase-2001  --numthread 1   --batch 1000  -o p1_q1000_cpu_dynedge_web-webbase-2001 .txt    &>> $output
...
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 128 --batch 1000  -o p128_q1000_cpu_statedge_web-webbase-2001 .txt  &>> $output
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 128 --batch 10000 -o p128_q10000_cpu_statedge_web-webbase-2001 .txt &>> $output
...
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 64  --batch 1000  -o p64_q1000_cpu_statedge_web-webbase-2001 .txt   &>> $output
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 64  --batch 10000 -o p64_q10000_cpu_statedge_web-webbase-2001 .txt  &>> $output
...
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 16  --batch 1000  -o p16_q1000_cpu_statedge_web-webbase-2001 .txt   &>> $output
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 16  --batch 10000 -o p16_q10000_cpu_statedge_web-webbase-2001 .txt  &>> $output
...
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 4   --batch 1000  -o p4_q1000_cpu_statedge_web-webbase-2001 .txt    &>> $output
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 4   --batch 10000 -o p4_q10000_cpu_statedge_web-webbase-2001 .txt   &>> $output
...
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 1   --batch 1000  -o p1_q1000_cpu_statedge_web-webbase-2001 .txt    &>> $output
python3 run.py --algorithm statedge --dataset web-webbase-2001  --numthread 1   --batch 10000 -o p1_q10000_cpu_statedge_web-webbase-2001 .txt   &>> $output
