...
python3 run.py --algorithm dynedge --dataset email-enron   --gpu --batch 1000     -o p64_q1000_gpu_dynedge_email-enron.txt        &>> $output
python3 run.py --algorithm dynedge --dataset email-enron   --gpu --batch 5000    -o p64_q5000_gpu_dynedge_email-enron.txt       &>> $output
python3 run.py --algorithm dynedge --dataset email-enron   --gpu --batch 100000   -o p64_q100000_gpu_dynedge_email-enron.txt      &>> $output
...
python3 run.py --algorithm statedge --dataset email-enron   --gpu --batch 1000     -o p64_q1000_gpu_statedge_email-enron.txt      &>> $output
python3 run.py --algorithm statedge --dataset email-enron   --gpu --batch 5000    -o p64_q5000_gpu_statedge_email-enron.txt     &>> $output
python3 run.py --algorithm statedge --dataset email-enron   --gpu --batch 100000   -o p64_q100000_gpu_statedge_email-enron.txt    &>> $output
