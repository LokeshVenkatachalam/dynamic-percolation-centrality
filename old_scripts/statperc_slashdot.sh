output=slashdot_statperc.txt  
python3 run.py --algorithm statperc --dataset slashdot         --numthread 96 --batch 1   -o p96_q1_cpu_statperc_slashdot.txt            &>> $output
python3 run.py --algorithm statperc --dataset slashdot         --numthread 96 --batch 10  -o p96_q10_cpu_statperc_slashdot.txt           &>> $output
python3 run.py --algorithm statperc --dataset slashdot         --numthread 96 --batch 40  -o p96_q40_cpu_statperc_slashdot.txt           &>> $output
python3 run.py --algorithm statperc --dataset slashdot         --numthread 96 --batch 100 -o p96_q100_cpu_statperc_slashdot.txt          &>> $output
