...
# Compile GPU executables for edge updates
echo "Compiling GPU edge update executables..."
nvcc -O3 "$SRC_DIR/dynamic-edge-update.cu" -o "$EXEC_DIR/deu"
nvcc -O3 "$SRC_DIR/static-edge-update.cu" -o "$EXEC_DIR/seu"
...
echo "All GPU edge update experiments finished."
