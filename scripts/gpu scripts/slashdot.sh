...
python3 run.py --algorithm dynedge --dataset slashdot   --gpu --batch 1000     -o p64_q1000_gpu_dynedge_slashdot.txt        &>> $output
python3 run.py --algorithm dynedge --dataset slashdot   --gpu --batch 5000    -o p64_q5000_gpu_dynedge_slashdot.txt       &>> $output
python3 run.py --algorithm dynedge --dataset slashdot   --gpu --batch 100000   -o p64_q100000_gpu_dynedge_slashdot.txt      &>> $output
...
python3 run.py --algorithm statedge --dataset slashdot   --gpu --batch 1000     -o p64_q1000_gpu_statedge_slashdot.txt      &>> $output
python3 run.py --algorithm statedge --dataset slashdot   --gpu --batch 5000    -o p64_q5000_gpu_statedge_slashdot.txt     &>> $output
python3 run.py --algorithm statedge --dataset slashdot   --gpu --batch 100000   -o p64_q100000_gpu_statedge_slashdot.txt    &>> $output
