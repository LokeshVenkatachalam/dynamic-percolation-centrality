output=brightkite_dynedge.txt  
python3 run.py --algorithm dynedge --dataset brightkite         --numthread 96 --batch 1   -o p96_q1_cpu_dynedge_brightkite.txt            &>> $output
python3 run.py --algorithm dynedge --dataset brightkite         --numthread 96 --batch 10  -o p96_q10_cpu_dynedge_brightkite.txt           &>> $output
python3 run.py --algorithm dynedge --dataset brightkite         --numthread 96 --batch 40  -o p96_q40_cpu_dynedge_brightkite.txt           &>> $output
python3 run.py --algorithm dynedge --dataset brightkite         --numthread 96 --batch 100 -o p96_q100_cpu_dynedge_brightkite.txt          &>> $output
