...
python3 run.py --algorithm dynedge --dataset brightkite   --gpu --batch 1000     -o p64_q1000_gpu_dynedge_brightkite.txt        &>> $output
python3 run.py --algorithm dynedge --dataset brightkite   --gpu --batch 5000    -o p64_q5000_gpu_dynedge_brightkite.txt       &>> $output
python3 run.py --algorithm dynedge --dataset brightkite   --gpu --batch 100000   -o p64_q100000_gpu_dynedge_brightkite.txt      &>> $output
...
python3 run.py --algorithm statedge --dataset brightkite   --gpu --batch 1000     -o p64_q1000_gpu_statedge_brightkite.txt      &>> $output
python3 run.py --algorithm statedge --dataset brightkite   --gpu --batch 5000    -o p64_q5000_gpu_statedge_brightkite.txt     &>> $output
python3 run.py --algorithm statedge --dataset brightkite   --gpu --batch 100000   -o p64_q100000_gpu_statedge_brightkite.txt    &>> $output